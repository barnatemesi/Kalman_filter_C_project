...
static VectorT kf_second_line_of_state_space(const VectorT *kf_state_vec_inp, const VectorT *kf_u_signal_inp)
{
	...
	kf_matrix_mult_temp2.vector[0] = (d_matrix_D_DU.matrix[0] * kf_u_signal_inp->vector[0]) +
	                                 (d_matrix_D_DU.matrix[2] * kf_u_signal_inp->vector[1]);

	kf_matrix_mult_temp2.vector[1] = (d_matrix_D_DU.matrix[1] * kf_u_signal_inp->vector[0]) +
